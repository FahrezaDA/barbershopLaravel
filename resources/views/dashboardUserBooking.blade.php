            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @endphp
                        <button onclick="window.location.href='/login'" style="background-color: #4E73DF; color: white; height: 40px; width:150px; margin: 10px 10px 10px 10px;">
    <b>Login Admin</b>
</button>
                    ...
                    <div class="container">
                        <div class="card mt-5">
                            <div class="card-body">
                                ...
                                <a href="/landingpage" type="submit" name="register" class="btn btn-primary">kembali</a>
                            </div>
                        </div>
                    </div>
